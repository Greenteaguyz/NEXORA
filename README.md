...
| **[Pages & Components Map](../pages_components_map.md)**               | Master component registry (25 components), ASCII layout wireframes, cross-cutting DI dependency matrix, and Mermaid component graph.                              |
