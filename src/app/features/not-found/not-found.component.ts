...
@Component({
  ...
  template: `
    <div style="position: relative; padding: 96px 24px; flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; overflow: hidden;">
