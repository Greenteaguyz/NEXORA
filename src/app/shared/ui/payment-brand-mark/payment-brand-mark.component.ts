    ...
    @switch (mark()) {
      ...
      @case ('aba') {
        <svg class="brand-mark" viewBox="0 0 64 22" role="img" aria-label="ABA Bank" [attr.height]="height()">
          <rect x="0.5" y="0.5" width="63" height="21" rx="3" fill="#E31E24"/>
          <text x="32" y="15.5" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="10" font-weight="800" letter-spacing="1.5" fill="#FFFFFF">ABA</text>
        </svg>
      }
      @case ('khqr') {
